...
class LLMService:
    ...
    def _prepare_context(self, playlist: Playlist) -> str:
        """
    ...
    async def generate_summary(self, playlist: Playlist) -> SummaryResult:
        """
        ...
        context_text = self._prepare_context(playlist)
